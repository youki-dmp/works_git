...
- **Bilingual Documentation / ドキュメントの二ヶ国語併記**:
  - All implementation plans, workflows, and walkthroughs must include both Japanese and English.
  - 計画表（implementation plans）、ワークフロー（workflows）、および報告書（walkthroughs）には、必ず日本語と英語を併記してください。
- **Format / 形式**:
