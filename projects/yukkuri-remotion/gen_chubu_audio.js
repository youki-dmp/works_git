...
async function main() {
    ...
    // Specifically target Chubu prefectures that have generic text
    const chubuPrefectures = ["niigata", "toyama", "ishikawa", "fukui", "yamanashi", "nagano", "gifu", "shizuoka", "aichi"];

    for (const prefId of chubuPrefectures) {
        console.log(`--- Processing Pattern A for: ${prefId} ---`);
        const dialogue = allRegions.chubu[prefId];
    ...
    console.log('Chubu V3 audio generation complete!');
}
