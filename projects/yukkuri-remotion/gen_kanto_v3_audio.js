...
async function main() {
    ...
    const kantoPrefs = ["tokyo", "kanagawa", "saitama", "chiba", "ibaraki", "tochigi", "gunma"];

    for (const prefId of kantoPrefs) {
        console.log(`--- Processing V3 Audio for: ${prefId} ---`);
        const dialogue = allRegions.kanto[prefId];
    ...
    console.log('Kanto V3 audio generation complete!');
}
